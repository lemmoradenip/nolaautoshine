...
public partial class Print : System.Web.UI.Page
{
    ...
    public void BindInvoiceHeader()
    {
        try
        {
            string qry = String.Format("SELECT TOP 1000 [id],[Name],[Mobile],[Email],[carmake],[ScheduledDate],[ScheduledTime],[Address],[CreatedDate],case when Ispaid=1 then 'PAID' ELSE 'UNPAID' END,[VehicleType],[color],[Model]"
