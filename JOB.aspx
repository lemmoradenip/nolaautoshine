<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JOB.aspx.cs" Inherits="Print" %>
            ...
            <table class="table-form">
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <td style="background-color:yellow" >JOB STATUS</td>
                    <td >
                         <asp:Button ID="btndone" OnClick="btndone_Click" ForeColor="White"   CssClass="button" Text="DONE" BackColor="Green" runat="server" />
                         <asp:Button ID="btnundone" OnClick="btnundone_Click" Text="NOT DONE" ForeColor="White" BackColor="Red" runat="server" />
